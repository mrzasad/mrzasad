...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/mrzasad)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mrzasad@gmail.com)
[![Location](https://img.shields.io/badge/Chicago%2C%20IL-USA-0f2027?style=for-the-badge&logo=googlemaps&logoColor=white)](#)
...
| Domain | Achievement |
|--------|-------------|
| **ETL at Scale** | ADF + .NET pipeline normalizing **3.3M OpenFoodFacts records** to Parquet + Cosmos DB — total run cost ~$10 |
| **AI Observability** | Full per-call LLM traceability (prompts, responses, datasets, versions) for audit-compliant regulated systems |
| **Model Compression** | BERT → DistilBERT distillation (PyTorch) — **10× parameter reduction**, retaining **97% accuracy** |
| **Legacy Migration** | Monolith → DDD microservices with strict TDD; BrainCloud → Cosmos DB for real-time analytics |
| **LLM Safety** | Production guardrail system blocking injection, jailbreaks, and PII leakage at inference boundary |
...
![CosmosDB](https://img.shields.io/badge/Cosmos_DB-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white)
